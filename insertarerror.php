...
if(isset($_GET["partido"])){
    ...
    $sqljugadores = mysqli_query($conexionBD,"INSERT INTO errores (tipo,descripcion,parte,minuto,cod_partido,dni_jugador,cod_cat) VALUES ('$tipo','$descripcion','$parte','$minuto','$cod_partido','$dni','$cod_cat') ");
