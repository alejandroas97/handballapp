...
if (isset($_GET["consultar"])){
    $dni=$_GET["consultar"];
    $sqljugadores = mysqli_query($conexionBD,"SELECT tipo,descripcion,parte,minuto,cod_partido,equipo_contrario FROM `errores` INNER JOIN partidos ON partidos.cod=errores.cod_partido WHERE dni_jugador = '$dni';");
